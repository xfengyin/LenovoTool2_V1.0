"""Mock battery data source for development and testing.

Provides realistic battery simulation with changing values to mimic
real-world battery behavior during development and testing.
"""
...
class MockDataSource(BatteryDataSource):
    """Mock battery data source with realistic simulation.

    Simulates realistic battery behavior including:
    - State of Health (SOH) gradual degradation
    - State of Charge (RSOC) cycling
